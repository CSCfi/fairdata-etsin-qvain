...
export const DaasCatalogFormBase = () => {
  const {
  ...
  useEffect(() => {
    const daasConfig = dataCatalogConfigs[DATA_CATALOG_IDENTIFIER.DAAS]
    const services = daasConfig?.data_services || []
...
export default observer(DaasCatalogFormBase)
