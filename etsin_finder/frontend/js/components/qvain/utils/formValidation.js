...
const actorRolesSchema = yup
  ...
  .of(
    yup
      .mixed()
      .oneOf(
        [ROLE.CREATOR, ROLE.CURATOR, ROLE.PUBLISHER, ROLE.RIGHTS_HOLDER, ROLE.CONTRIBUTOR, ROLE.PROVENANCE],
...
// TEMPORAL VALIDATION
const temporalDateSchema = yup
  .object()
  .shape({
  startDate: yup
      .date()
      .required('qvain.temporalAndSpatial.temporal.error.startDateMissing'),
  endDate: yup
      .date()
      .required('qvain.temporalAndSpatial.temporal.error.endDateMissing')
})
