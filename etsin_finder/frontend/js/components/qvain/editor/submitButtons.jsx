        ...
        >
          ...
          >
            <SubmitButton
              ...
              onClick={() => this.submit(this.handleCreateNewDraft)}
            >
      ...
      submitDraft = (
        ...
        >
          ...
          >
            <SubmitButton
              disabled={disabledDueToReadOnly || disabledDueToMissingFieldsDraft}
              onClick={() => this.submit(this.handleUpdate)}
            >
              <Translate content="qvain.saveDraft" />
            </SubmitButton>
          </WrapperDivForHovering>
        ...
        submitPublished = (
          ...
          >
            ...
            >
              <SubmitButton
                disabled={disabledDueToReadOnly || disabledDueToMissingFieldsNonDraft}
                onClick={() => this.submit(this.handleMergeDraft)}
              >
                <Translate content="qvain.submit" />
              </SubmitButton>
            </WrapperDivForHovering>
        ...
        submitPublished = (
          ...
          >
            ...
            >
              <SubmitButton
                disabled={disabledDueToReadOnly || disabledDueToMissingFieldsNonDraft}
                onClick={() => this.submit(this.handlePublishDataset)}
              >
                <Translate content="qvain.submit" />
              </SubmitButton>
            </WrapperDivForHovering>
      ...
      submitDraft = (
        ...
        >
          ...
          >
            <SubmitButton
              disabled={disabledDueToReadOnly || disabledDueToMissingFieldsDraft}
              onClick={() => this.submit(this.handleSaveAsDraft)}
            >
              <Translate content="qvain.saveDraft" />
            </SubmitButton>
          </WrapperDivForHovering>
      ...
      submitPublished = (
        ...
        >
          ...
          >
            <SubmitButton
              disabled={disabledDueToReadOnly || disabledDueToMissingFieldsNonDraft}
              onClick={() => this.submit(this.handleUpdate('saveAndPublish'))}
            >
              <Translate content="qvain.submit" />
            </SubmitButton>
          </WrapperDivForHovering>
