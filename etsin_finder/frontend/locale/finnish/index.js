...
const finnish = {
  ...
  dataset: {
    ...
    access_modal: {
      ...
      application: 'Hakemus',
      createApplication: 'Luo hakemus',
      stateInfo: {
        state: 'Hakemuksen tila',
        submitted: 'Lähetetty',
        modified: 'Muokattu',
      },
    ...
    embargoDateExpired: 'Embargo päättynyt',
    events_idn: {
      deleted_versions: {
      ...
      events: {
        ...
        subheads: {
          userEnteredEvents: 'Käyttäjän lisäämät tapahtumat',
          serviceGeneratedEvents: 'Palvelun luomat tapahtumat',
        },
      },
      preservationEvent: {
        useCopy: {
    ...
    project: {
      project_area: 'Projektit ja rahoitus',
      project_title: 'Projekti',
      name: 'Projektin nimi',
      identifier: 'Projektin tunniste',
      sourceOrg: 'Osallistuvat organisaatiot',
      funding: 'Rahoitus',
      has_funder_identifier: 'Rahoituksen tunniste',
      funder: 'Rahoittajaorganisaatio',
      funder_plural: 'Rahoittajaorganisaatiot',
