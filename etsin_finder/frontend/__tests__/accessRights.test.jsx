...
describe('AccessRights', () => {
  ...
  describe('render with access rights true', () => {
    const accessRights = shallow(<AccessRights access_rights={ { type: [{identifier: 'http://purl.org/att/es/reference_data/access_type/access_type_open_access', pref_label: {'fi': 'title'}}] } } Stores={{Locale: { currenLang: 'en' }}} />);
  ...
  describe('render with access rights anything else', () => {
    const accessRights = shallow(<AccessRights access_rights={ { license: [{identifier: 'something', pref_label: {'fi': 'title'}}] } } Stores={{Locale: { currenLang: 'en' }}} />);
